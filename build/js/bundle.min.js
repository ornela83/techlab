function iniciarApp(){eventListeners(),activeLink()}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",()=>{document.querySelector(".navegacion").classList.toggle("mostrar")})}function activeLink(){const e=location.href;document.querySelectorAll(".navegacion a").forEach(n=>{n.href===e&&(n.className="active")})}
